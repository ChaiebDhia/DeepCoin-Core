    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="rounded-xl border overflow-hidden" style={{ borderColor: "var(--border)" }}>
        ...
        >
          ...
          <span className="flex-1 min-w-0">{t("col_image_type")}</span>

          <span className="w-[120px] shrink-0">{t("col_route")}</span>

          <span className="w-[110px] shrink-0">{t("col_confidence")}</span>

          <span className="w-[100px] shrink-0">{t("col_date")}</span>

          <span className="w-[44px] shrink-0 text-right">{t("col_report")}</span>
            ...
            {onDelete && (
              ...
              <div className="w-10 shrink-0 flex items-center justify-center">
                ...
                <button
                  ...
                  aria-label={t("btn_delete_record")}
      ...
      {(
        ...
        >
          ...
          <span>
            ...
            {skip + 1}–{Math.min(skip + limit, total)} {t("of")} {total}

            {filteredItems.length < items.length && (

              <span style={{ color: "var(--brand-light)" }} className="ml-1">

                · {filteredItems.length} {t("shown_after_filter")}
